...
class MenusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'order' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'order' => 1,
            'parent_id' => 1,
            'created' => '2018-04-13 12:34:13',
            'modified' => '2018-04-13 12:34:13'
        ],
    ];
}
